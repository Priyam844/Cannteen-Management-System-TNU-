...
import 'package:flutter_application_1/services/api_service.dart'; // 🔥 add this at topr

////////////////////////////////////////////////////////////
/// ROLE ENUM
////////////////////////////////////////////////////////////
enum UserRole { student, faculty, manager, admin }
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            /// 🔷 SIGNUP (student or faculty)
                            if (selectedRole == UserRole.student || selectedRole == UserRole.faculty)
                              TextButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
