...
class ApiService {
  ...
  ////////////////////////////////////////////////////////////
  /// CORE AUTH STREAMED REQUEST HANDLER
  ////////////////////////////////////////////////////////////
  static Future<http.StreamedResponse> _withRefreshStreamed(
    ...
    http.StreamedResponse res = await request(token);
  ...
  static Future<http.StreamedResponse> putMultipart(
    ...
    return _withRefreshStreamed((token) async {
